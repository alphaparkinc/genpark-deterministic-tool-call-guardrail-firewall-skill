# genpark-deterministic-tool-call-guardrail-firewall-skill
...
> **GenPark AI Agent Skill** -- Deterministic tool-call guardrail firewall & injection interceptor (NeMo Guardrails)
